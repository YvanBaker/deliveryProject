...
<body class="easyui-layout" style="visibility:hidden;">
    <div region="west" title="查询条件" icon="icon-forward" style="width:180px;overflow:auto;" split="false" border="true" >
		<div class="datagrid-toolbar">	
			<a id="reset" href="javascript:void(0);" class="easyui-linkbutton" plain="true"  icon="icon-reload">重置</a>
		</div>
		...
		<form id="form" method="post" >
			<table class="table-edit" width="100%">
				...
				<tr><td>
					...
					<input type="text" id="birthday" name="birthday" value="1999-11-11" class="easyui-datebox" /><br/>
    ...
    <div region="center" style="overflow:hidden;" border="false">
		<iframe id="list" src="/sys/userlist" scrolling="no" style="width:100%;height:100%;border:0;"></iframe>
    </div>
</body>
</html>